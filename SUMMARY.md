...
* [API Reference](reference/api-reference/README.md)
  * [ThinQ API](reference/api-reference/thinq-api.md)
    * [APIs](reference/api-reference/thinq-api/apis/README.md)
      ...
      * [GET /home/devices](reference/api-reference/thinq-api/apis/get-home-devices.md)
      * [POST /device](reference/api-reference/thinq-api/apis/post-device.md)
      * [GET /device](reference/api-reference/thinq-api/apis/get-device.md)
      * [POST /device/control](reference/api-reference/thinq-api/apis/post-device-control.md)
      * [DELETE /device](reference/api-reference/thinq-api/apis/delete-device.md)
      * [POST /monitoring](reference/api-reference/thinq-api/apis/post-monitoring.md)
  ...
  * [Hub API](reference/api-reference/hub-api.md)
    * [APIs](reference/api-reference/hub-api/apis/README.md)
      ...
      * [등록 / 삭제 결과 확인](reference/api-reference/hub-api/apis/get-progress-register-register-id.md)
