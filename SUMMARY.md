...
* [API Reference](reference/api-reference/README.md)
  * [ThinQ API](reference/api-reference/thinq-api.md)
    * [APIs](reference/api-reference/thinq-api/apis/README.md)
      * [ThinQ 계정 등록하기](reference/api-reference/thinq-api/apis/post-account.md)
      * [사용자 홈 목록 조회하기](reference/api-reference/thinq-api/apis/get-home.md)
      * [사용자 기기 목록 조회하기](reference/api-reference/thinq-api/apis/get-home-devices.md)
