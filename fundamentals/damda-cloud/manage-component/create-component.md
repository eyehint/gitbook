...
컴포넌트의 기타 정보를 태그로 추가해서 관리할 수 있습니다. AppName 태그를 추가하는 경우, home에서 태그의 값으로 앱 이름이 보이게 됩니다. 태그 정보 입력 후 <mark style="color:blue;">**"+"**</mark>를 눌러주어야 추가되니 주의해주세요.
...
![](<../../../.gitbook/assets/image (2) (7) (1).png>) ![](<../../../.gitbook/assets/image (14) (3).png>)
